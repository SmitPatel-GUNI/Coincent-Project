      ...
      <div class="navigation">
        <div class="sidenav" id="jstoggle">
          ...
          <div class="Widgets" id="jstoggle">
            <a href="./applicant_dashboard.php" class="active"><i class="fa-solid fa-gauge"></i>Dashboard</a>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            ?>
                                ...
                                <div class="job-content">
                                    ...
                                    <div class="btn">
                                        <?php echo '<a href="./job_apply_form.php?job_name='.$data['Position'].'" class="apply_btn">Apply Now</a>'; ?>
